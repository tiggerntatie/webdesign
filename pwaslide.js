...
var username = "116625764666503056459"; // username for your picasa web album account
var album = "Homecoming"; // name of album (Folder name)
var show_all_albums = 0; // 0 = only use album specified in album variable. 1 = show photos from all picasa albums
var phwidth = 379; // pictureholder width
var phheight = 306; // pictureholder height
...
if (show_all_albums == 0)
	...
	document.write('<script type="text/javascript" src="http://picasaweb.google.com/data/feed/base/user/'+username+'?category=photo&alt=json&callback=loadpics"></script>'); // get list of pics and put in pictures array
